...
type BackendContextType = {
  ...
  userTurn: (text: string, params?: Partial<{ cwd: string; approval_policy: string; sandbox_mode: string; model: string; effort: string; summary: string; local_images: string[]; image_urls: string[] }>) => Promise<boolean>;
